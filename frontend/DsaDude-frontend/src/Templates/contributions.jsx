    ...
    <div className="page-inner">
      ...
      {!user ? (
        <div className="problems-card animate-fadeInUp" style={{ maxWidth: "900px", margin: "0 auto", padding: "2rem", textAlign: "center" }}>
          <h2 style={{ marginBottom: "0.5rem" }}>Please login to view your contributions</h2>
        ...
        <div className="problems-card animate-fadeInUp" style={{ maxWidth: "900px", margin: "0 auto", padding: "2rem", textAlign: "center" }}>
          <h2 style={{ marginBottom: "0.5rem" }}>No contributions yet</h2>
          <p className="text-secondary" style={{ marginBottom: "1rem" }}>
            Start a draft from the navbar to see your authored problems here.
          </p>
        </div>
      ) : (
